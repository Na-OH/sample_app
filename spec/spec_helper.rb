...
Spork.prefork do
  ...
  #Checks for pending migrations before test are run.
  ...
  RSpec.configure do |config|
    ...
    config.fixture_path = "#{::Rails.root}/spec/flextures"
    ...
    # find an order dependency and wand to debug it, you can fix the
